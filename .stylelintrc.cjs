module.exports = {
    ...
    */
    rules: {
        ...
        'function-ur1-quotes': 'always',// 要求或禁止URL 的引号"always(必须加上引号)"|"never(没有引号)"
        ...
        'selector-pseudo-c1ass-no-unknown': [
            // 不允许未知的选择器
            true,
            {
                ignorePseudoc1asses: ['qlobal', 'v-deep', 'deep'],// 忽略属性,修改element默认样式的时候能使用到
            },
        ],
    },
}