...
export const reqAllPermission = () =>
  request.get<string, PermissionResponseData>(API.ALLPERMISSION_URL);
// 新增菜单
...
// 删除菜单
export const reqRemovePeremission = (id: number) =>
  request.delete<string, any>(API.REMOVEPERMISSION_URL + id);
