  ...
  <el-form label-width="100">
    ...
    <el-form-item label="平台属性" v-loading="attrListLoading">
      <el-form :inline="true" label-width="100">
        <el-form-item :label="item.attrName" v-for="item in attrArr" :key="item.id" style="margin-bottom:5px;">
    ...
    <el-form-item label="图片名称" v-loading="imageListLoading">
      <el-table border :data="imageArr" ref="imgTable">
        ...
        <el-table-column align="center" label="操作">
          <template #="{ row }">
            <el-button type="primary" size="small" @click="handleSetImg(row)">设置默认</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-form-item>
